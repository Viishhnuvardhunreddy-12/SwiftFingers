      ...
      <div className="flex-1 flex flex-col gap-6">
        ...
        <div className="relative rounded-3xl flex-1 flex flex-col">
            ...
            <div className="relative z-10 flex-1 p-8 md:p-12 bg-slate-900/50 border border-slate-800 backdrop-blur-md rounded-3xl overflow-hidden shadow-2xl flex flex-col items-center justify-center min-h-[300px]">
                ...
                {/* Start Prompt - bottom hint only, text stays fully visible */}
                {!isActive && gameState === 'IDLE' && (
                    <div className="absolute bottom-4 left-0 right-0 flex items-center justify-center pointer-events-none z-20">
                        <div className="flex items-center gap-2 px-4 py-1.5 bg-black/60 rounded-full animate-pulse">
                            <Zap className="w-4 h-4 text-blue-400" />
                            <span className="text-white text-sm font-medium">Start typing to begin</span>
                        </div>
                    </div>
                )}
