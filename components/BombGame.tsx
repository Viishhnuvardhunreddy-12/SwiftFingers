  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-3xl flex flex-col items-center gap-8">
        ...
        {/* Overlays */}
        {/* IDLE: subtle bottom hint, word stays fully visible */}
        {gameState === 'IDLE' && (
            <div className="absolute bottom-4 left-0 right-0 flex items-center justify-center pointer-events-none z-20">
                <div className="flex items-center gap-2 px-4 py-1.5 bg-black/70 rounded-full animate-pulse border border-amber-500/30">
                    <AlertTriangle className="w-4 h-4 text-amber-400" />
                    <span className="text-amber-300 text-sm font-medium">Type exact characters — one mistake detonates</span>
                </div>
            </div>
        )}
