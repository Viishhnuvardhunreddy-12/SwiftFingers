        ...
        >
            ...
            {gameState === 'IDLE' && (
                <div className="absolute bottom-6 left-0 right-0 flex items-center justify-center z-50 pointer-events-none">
                    <div className="flex items-center gap-2 px-5 py-2 bg-black/70 rounded-full border border-indigo-500/30 animate-pulse">
                        <Target className="w-4 h-4 text-indigo-400" />
                        <span className="text-white text-sm font-medium">Type any falling word to start shooting</span>
                    </div>
                </div>
            )}
